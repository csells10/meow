...
# ---------------------------------------------
DERIVED_METRICS = {
    "points_per_play": {"numerator": "actual_points", "denominator": "total_plays", "category": "Scoring & Efficiency", "core_area": "Offense"},
    "points_allowed_per_play": {"numerator": "points_allowed", "denominator": "opponent_total_plays", "category": "Scoring & Efficiency", "core_area": "Defense"},
    "td_rate": {"numerator": "passing_tds_rushing_tds_sum", "denominator": "total_plays", "category": "Scoring & Efficiency", "core_area": "Offense"},
    "red_zone_efficiency": {"numerator": "red_zone_tds", "denominator": "red_zone_attempts", "category": "Red Zone & Conversion", "core_area": "Offense"},
    "third_down_pct": {"numerator": "third_down_conversions", "denominator": "third_down_attempts", "category": "Red Zone & Conversion", "core_area": "Offense"},
    "fourth_down_pct": {"numerator": "fourth_down_conversions", "denominator": "fourth_down_attempts", "category": "Red Zone & Conversion", "core_area": "Offense"},
    "run_play_pct": {"numerator": "rushing_attempts", "denominator": "total_plays", "category": "Play Calling & Strategy", "core_area": "Offense"},
    "pass_play_pct": {"numerator": "pass_attempts", "denominator": "total_plays", "category": "Play Calling & Strategy", "core_area": "Offense"},
    "pass_run_ratio": {"numerator": "pass_attempts", "denominator": "rushing_attempts", "category": "Play Calling & Strategy", "core_area": "Offense"},
    "1st_down_rate": {"numerator": "first_downs", "denominator": "total_plays", "category": "Sustained Drives", "core_area": "Offense"},
    "pass_td_share": {"numerator": "passing_tds", "denominator": "passing_tds_rushing_tds_sum", "category": "Sustained Drives", "core_area": "Offense"},
    "rush_td_share": {"numerator": "rushing_tds", "denominator": "passing_tds_rushing_tds_sum", "category": "Sustained Drives", "core_area": "Offense"},
    "offensive_snap_load": {"numerator": "total_offensive_snaps", "denominator": "total_snaps", "category": "Snap Load", "core_area": "Offense"},
        ...
        for metric, meta in DERIVED_METRICS.items():
            ...
            for i, row in cumsum.iterrows():
                results.append({
                    ...
                    "value": round(series.iloc[i], 3) if pd.notna(series.iloc[i]) else None,
                })
